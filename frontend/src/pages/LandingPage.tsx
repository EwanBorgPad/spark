      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-accent/80 backdrop-blur-md border-b border-fg-primary/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Img src={boltLogo} size="custom" customClass="w-10 h-10 rounded-lg" alt="Spark-it Logo" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-8 text-sm">
              ...
              <a href="https://twitter.com/sparkit" target="_blank" rel="noopener noreferrer" className="text-fg-primary/60 hover:text-brand-primary transition-colors">Twitter</a>
              <a href="https://discord.gg/sparkit" target="_blank" rel="noopener noreferrer" className="text-fg-primary/60 hover:text-brand-primary transition-colors">Discord</a>
            </div>
          </div>
