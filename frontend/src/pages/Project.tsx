...
const Project = () => {
  ...
  return (
    <main className="z-[10] flex w-full max-w-full select-none flex-col items-center gap-8 overflow-y-hidden py-[72px] font-normal text-fg-primary lg:py-[100px]">
      ...
      <section className="flex w-full flex-col items-center gap-6 px-4">
        {/* heading */}
        <div className="flex w-full flex-col justify-between gap-6 md:flex-row md:items-end lg:max-w-[760px]">
          {/* left side */}
