...
import discoverBlitzLogoSmall from "@/assets/landingPage/bolt-logo-small.png"
import discoverGoatLogoSmall from "@/assets/landingPage/goat-logo-small.png"
...
const DiscoverSection = () => {
  ...
  return (
    <section className="flex w-full flex-col items-center gap-6 px-5 py-16 md:gap-[60px] md:px-16 md:py-10">
      <h2 className="text-center text-2xl font-semibold leading-[44px]">Discover the BetterThanCEX Ecosystem</h2>
