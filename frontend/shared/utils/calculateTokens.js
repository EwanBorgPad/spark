 ...
 */
export const calculateTokens = ({ projectData, borgCoinInput, borgPriceInUSD }) => {
    ...
    const getTokenRewards = () => {
        if (!borgCoinInput || !tokenPriceInBORG || !borgPriceInUSD)
    ...
    const getTotalTokensToBeReceived = () => {
        ...
        const totalTargetToken = formatCurrencyAmount(totalTokensReceivedInRewardsDistribution + totalTokensFromLiquidityPool);
