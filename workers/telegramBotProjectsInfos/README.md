...
wrangler secret put CREATE_PROJECT_API_URL --config wrangler_production.toml
wrangler secret put CREATE_PROJECT_API_KEY --config wrangler_production.toml
```
...
wrangler secret put CREATE_PROJECT_API_URL --config wrangler_staging.toml
wrangler secret put CREATE_PROJECT_API_KEY --config wrangler_staging.toml
```